  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-2 border-t pt-3 text-sm">
        <div className="text-sm font-semibold">Informações pessoais</div>
        <div>
          <div className="text-xs font-normal text-muted-foreground">Telefone</div>
          <div className="font-medium">{stats.telefone || "-"}</div>
        </div>
        <div>
          <div className="text-xs font-normal text-muted-foreground">Endereço</div>
          <div className="font-medium">{enderecoTexto || "Não informado"}</div>
        </div>
      </div>
    </div>
  );
