...
export async function GET(request: Request) {
  ...
  const d = await detalheConfiguracoes(sessao.lojaId, sessao.id, sessao.perfil, baseUrlDe(request));
  ...
  return NextResponse.json({
    ...
    pagamento: {
      ...
      pix: d.pagamento.pix,
      credito: { ativo: d.pagamento.credito.ativo, taxa_ativa: d.pagamento.credito.taxaAtiva, taxa: d.pagamento.credito.taxa, bandeiras: d.pagamento.credito.bandeiras, bandeiras_custom: d.pagamento.credito.bandeirasCustom },
      debito: { ativo: d.pagamento.debito.ativo, taxa_ativa: d.pagamento.debito.taxaAtiva, taxa: d.pagamento.debito.taxa, bandeiras: d.pagamento.debito.bandeiras, bandeiras_custom: d.pagamento.debito.bandeirasCustom },
