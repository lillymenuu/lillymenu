...
(function(){
  const paginas = [
    ...
    { nome:'Matéria-prima',         url:'cad_materia_prima.php',           icone:'bi-box-seam' },
    { nome:'Pedidos (PDV)',         url:'pdv.php',                         icone:'bi-bag-check' },
    { nome:'Gestor de Pedidos',     url:'gestor_pedidos.php',              icone:'bi-kanban' },
    { nome:'Lista de Pedidos',      url:'pedidos.php',                     icone:'bi-receipt' },
    { nome:'Orçamento/Recibo',      url:'orcamentos.php',                  icone:'bi-file-earmark-text' },
    { nome:'Produtos',              url:'produtos.php',                    icone:'bi-bag' },
    { nome:'Promo',                 url:'promo.php',                       icone:'bi-gift' },
    { nome:'Estoque',               url:'estoque.php',                     icone:'bi-box-seam' },
    { nome:'Clientes',              url:'clientes.php',                    icone:'bi-grid-3x3-gap' },
    { nome:'Relatórios',            url:'relatorios',                      icone:'bi-bar-chart' },
    { nome:'Relatório de clientes', url:'relatorios_clientes.php',         icone:'bi-people' },
    { nome:'Fidelidade',            url:'relatorios_fidelidade.php',       icone:'bi-award' },
    { nome:'Cross-sell',            url:'relatorio_cross_sell.php',        icone:'bi-shuffle' },
    { nome:'Entrada / saída',       url:'entrada_saida.php',               icone:'bi-arrow-left-right' },
    { nome:'Financeiro Dashboard',  url:'financeiro_dashboard.php',        icone:'bi-pie-chart' },
    { nome:'Lançamentos',           url:'financeiro_lancamentos.php',      icone:'bi-arrow-left-right' },
    { nome:'Categorias',            url:'financeiro_categorias.php',       icone:'bi-diagram-3' },
    { nome:'Contas',                url:'financeiro_contas.php',           icone:'bi-bank' },
    { nome:'Formas de pagamento',   url:'financeiro_formas_pagamento.php', icone:'bi-credit-card-2-front' },
    { nome:'DRE',                   url:'financeiro_dre.php',              icone:'bi-table' },
    { nome:'WhatsLilly',            url:'whatslilly.php',                  icone:'bi-whatsapp' },
    { nome:'Lista de Transmissão',  url:'lista_transmissao.php',           icone:'bi-broadcast' },
    { nome:'Motoboys',              url:'motoboys.php',                    icone:'bi-bicycle' },
    { nome:'Modo Garçom',           url:'modo_garcom.php',                 icone:'bi-person-badge' },
    { nome:'Controle de caixa',     url:'controle_caixa.php',              icone:'bi-cash-stack' },
    { nome:'Controle de fiado',     url:'controle_fiado.php',              icone:'bi-journal-text' },
    { nome:'Cupons',                url:'cupons.php',                      icone:'bi-ticket-perforated' },
    { nome:'Avaliações',            url:'avaliacoes.php',                  icone:'bi-star-half' },
