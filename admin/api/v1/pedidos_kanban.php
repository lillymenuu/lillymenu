<?php
/*
 * Versao JSON de admin/api/pedidos_kanban.php para o novo frontend Next.js
 * (Gestor de Pedidos / ordermanager). Mesma logica de introspeccao de
 * colunas (compatibilidade com bancos antigos), so trocando sessao por
 * token Bearer.
 */
...
/* Aplica numeracao sequencial zerada */
...
echo json_encode(['ok' => true, 'pedidos' => $pedidos], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
