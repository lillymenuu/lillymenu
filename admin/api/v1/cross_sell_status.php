<?php
/*
 * Versao JSON (Bearer token) de admin/api/cross_sell_grupos.php, usada
 * pelo modal "Configuracoes do Cross-sell" em /settings (Next.js).
 *
 * Reaproveita exatamente a mesma logica de co-ocorrencia/fallback por
 * categoria de bebidas do legado — nada disso e duplicado ou alterado
 * aqui, so trocamos sessao por Bearer token.
 */
...
$ativo = config($conn, 'cross_sell_ativo', '0', $lojaId) === '1';
