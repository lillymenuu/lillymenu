<?php
/*
 * Versao JSON de admin/api/fiado_registrar.php para o novo frontend
 * Next.js — botao "Registrar fiado" do modal de cliente.
 */
...
function fiadoRegistrarEstrutura(PDO $conn): void {
  try {
