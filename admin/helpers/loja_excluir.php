<?php
/*
 * Exclusao completa de uma loja (e de tudo que pertence a ela). Compartilhado por
 * admin/api/lojas_delete.php (sessao) e admin/api/v1/superadmin_loja_excluir.php (token).
 * Quem chama ja deve ter validado que o usuario e superadmin.
 */
...
if (!function_exists('superadminExcluirLoja')) {
  /** @return array{ok:bool,msg?:string} */
  function superadminExcluirLoja(PDO $conn, int $lojaId): array {
    if ($lojaId <= 0) {
      return ['ok' => false, 'msg' => 'Loja invalida.'];
    }
  ...
  try {
    ...
    if ((int) $stmt->fetchColumn() > 0) {
      return ['ok' => false, 'msg' => 'Nao e possivel excluir a loja do superadmin.'];
    }
