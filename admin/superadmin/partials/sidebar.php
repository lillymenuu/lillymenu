...
?>
  <aside class="sidebar">
    ...
    <div>
      ...
      <nav>
        <a class="nav-item <?= $rota === 'dashboard.php' ? 'active' : '' ?>" href="dashboard.php" data-tooltip="Dashboard">
        ...
        <a class="nav-item <?= $rota === 'painel.php' ? 'active' : '' ?>" href="painel.php" data-tooltip="Painel">
        ...
        <a class="nav-item <?= $rota === 'suporte.php' ? 'active' : '' ?>" href="suporte.php" data-tooltip="Suporte">
        ...
        <a class="nav-item <?= $rota === 'integracoes.php' ? 'active' : '' ?>" href="integracoes.php" data-tooltip="Integracoes">
          <svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg>
          <span class="nav-label">Integrações</span>
          <svg class="chevron" viewBox="0 0 24 24"></svg>
        </a>
        <a class="nav-item <?= $rota === 'notificacoes.php' ? 'active' : '' ?>" href="notificacoes.php" data-tooltip="Notificações">
        ...
        <a class="nav-item <?= $rota === 'configuracoes.php' ? 'active' : '' ?>" href="configuracoes.php" data-tooltip="Configurações">
    ...
    <div>
      <nav>
        <a class="nav-item" href="../logout.php" data-tooltip="Sair">
